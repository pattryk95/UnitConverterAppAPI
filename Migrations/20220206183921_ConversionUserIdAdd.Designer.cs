...
namespace UnitConverterAppAPI.Migrations
{
    ...
    [Migration("20220206183921_ConversionUserIdAdd")]
    partial class ConversionUserIdAdd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UnitConverterAppAPI.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UnitConverterAppAPI.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UnitConverterAppAPI.Entities.Conversion", b =>
                {
                    b.HasOne("UnitConverterAppAPI.Entities.User", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("UnitConverterAppAPI.Entities.User", b =>
                {
                    b.HasOne("UnitConverterAppAPI.Entities.Role", "Role")
                        .WithMany()
